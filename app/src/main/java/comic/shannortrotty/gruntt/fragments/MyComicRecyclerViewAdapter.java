...
import comic.shannortrotty.gruntt.fragments.ItemFragment.OnListFragmentInteractionListener;
...
public class MyComicRecyclerViewAdapter extends RecyclerView.Adapter<MyComicRecyclerViewAdapter.ViewHolder> {
    ...
    public MyComicRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
