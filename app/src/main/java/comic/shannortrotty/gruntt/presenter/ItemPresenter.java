...
//          Throw some error here
    ...
    private ComicDetails checkDatabase(String comicName){
        ...
        String[] projection = {
                ...
                ComicDatabaseContract.ComicInfoEntry.COLUMN_NAME_ALT_TITLE,
                ComicDatabaseContract.ComicInfoEntry.COLUMN_NAME_AUTHOR,
                ComicDatabaseContract.ComicInfoEntry.COLUMN_NAME_DESCRIPTION,
                ComicDatabaseContract.ComicInfoEntry.COLUMN_NAME_GENRE,
                ComicDatabaseContract.ComicInfoEntry.COLUMN_NAME_STATUS,
                ComicDatabaseContract.ComicInfoEntry.COLUMN_NAME_RELEASE_DATE,
                ComicDatabaseContract.ComicInfoEntry.COLUMN_NAME_COMIC_IMAGE,
                ComicDatabaseContract.ComicInfoEntry.COLUMN_NAME_IS_FAVORITE
        };
        ...
        Cursor cursor = db.query(
                ComicDatabaseContract.ComicInfoEntry.TABLE_NAME_FAVORITE,                     // The table to query
        ...
        if ( cursor.getCount() > 0) {
            ...
            comicDetails.setFavoriteFromDatabase(cursor.getInt(
                    cursor.getColumnIndexOrThrow(ComicDatabaseContract.ComicInfoEntry.COLUMN_NAME_IS_FAVORITE)));
